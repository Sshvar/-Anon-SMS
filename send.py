...
# The Credit For This Code Goes To Panda Hackers https://github.com/Sshvar/
# And The Contributors Mentioned At https://github.com/Sshvar/ANon-SMS/
...
def update():
    ...
    for fl in stuff_to_update:
        dat = urllib.request.urlopen("https://raw.githubusercontent.com/Sshvar/Anon-SMS/master/" + fl).read()
        file = open(fl, 'wb')
        file.write(dat)
        file.close()
    print('\n\t\tUpdated Successfull !!!!')
...
ver = urllib.request.urlopen("https://raw.githubusercontent.com/Sshvar/Anon-SMS/master/.version").read().decode('utf-8')
verl = ''
try:
...
print('\n\tStarting Anon-SMS...\n')
try:
    noti = urllib.request.urlopen("https://raw.githubusercontent.com/Sshvar/Anon-SMS/master/.notify").read().decode('utf-8')
    if len(noti) > 10:
        print('\nNotification : ' + noti + '\n')
except Exception:
    pass
